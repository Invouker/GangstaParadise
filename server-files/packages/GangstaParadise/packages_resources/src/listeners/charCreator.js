...
mp.events.add("playerJoin", function (player) {
    ...
    player.loadCharacter = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.pool.query('SELECT `clothing` FROM `gp_users` WHERE `userName` = ?', [this.identity]).then(function (_a) {
                            var rows = _a[0];
                            _this.customCharacter = rows[0]["Outfit"];
    ...
    player.saveCharacter = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.pool.query('UPDATE `gp_users` SET `clothing` = ? WHERE `userName` = ?', [JSON.stringify(this.customCharacter), player.identity]).then(function () {
